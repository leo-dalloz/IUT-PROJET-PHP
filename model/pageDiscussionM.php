...
function createMessage($i_authorId, $i_discussionId)
{
    $dbLink = dbConnect();
    $d_date = date('Y-m-d H:i:s');
    $query = "INSERT INTO Message (discussionId, authorId, contents, date, state) VALUES ($i_discussionId, '$i_authorId', '', '$d_date', 1)";
