<?php
    ...
    */
    function sendMail($s_mail) {
      ...
      $s_msg .= 'http://projet-iut-info.alwaysdata.net/mdpoublie/PROJET-PHP/controller/generatePwdC.php?token=' . $a_tokenAndDate['token'] . '&step=hello <br><br>';
